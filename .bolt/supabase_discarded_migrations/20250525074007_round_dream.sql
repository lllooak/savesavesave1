/*
  ...
  1. New Tables
    - `affiliate_links` - Stores unique referral links for users
    - `affiliate_tracking` - Tracks visitor activity through affiliate links
    - `affiliate_conversions` - Records successful conversions (purchases)
    - `affiliate_commissions` - Tracks commission earnings for affiliates
...
-- Create trigger function to update affiliate tier based on earnings
...
-- Create trigger to update affiliate tier
...
-- Create function to confirm booking commission
...
-- Create trigger for booking commission
