/*
  # Fix affiliate program database schema

  1. New Fields
    - Add affiliate-related fields to users table
    - Create affiliate_links table for tracking referral codes
    - Create affiliate_tracking table for visit/signup/booking events
    - Create affiliate_commissions table for tracking earnings
    - Create affiliate_payouts table for managing payments
  ...
  3. Functionality
    - Add trigger to update affiliate tier based on earnings
    - Add function to confirm booking commissions
*/
