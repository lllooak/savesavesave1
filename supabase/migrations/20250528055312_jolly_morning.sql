/*
  ...
  1. New Tables
    - `affiliate_links` - Stores affiliate referral links
    ...
    - `purchases` - Records purchases for conversion tracking
    - `affiliate_conversions` - Links purchases to affiliate referrals
  ...
  3. Security
    ...
    - Set up triggers for automatic commission processing
*/
