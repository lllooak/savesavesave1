/*
  # Add function to complete request and pay creator

  1. Changes
    - Create a new function to handle request completion and creator payment
    - Ensure creator balance is only updated when video is sent
    - Add proper transaction handling and error checking

  2. Security
    - Function is security definer to bypass RLS
    - Proper validation of request status
