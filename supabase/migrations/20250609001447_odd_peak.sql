/*
  ...
  1. New Tables
    - `affiliate_links` - Stores affiliate link codes and related data
    - `affiliate_tracking` - Tracks affiliate visits, signups, and bookings
    - `affiliate_commissions` - Records commissions earned by affiliates
    - `affiliate_payouts` - Tracks payout requests and their status
    - `purchases` - Simple table to track purchases
  ...
  3. Functions
    ...
    - `confirm_booking_commission` - Handles commission confirmation when bookings complete
*/
