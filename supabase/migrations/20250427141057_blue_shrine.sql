/*
  ...
  1. Changes
    - Create a new admin user with email admin9@example.com and password 12121212
    - Ensure the user has admin role and full permissions
    - Add proper audit logging for the creation
