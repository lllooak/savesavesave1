...
CREATE OR REPLACE FUNCTION update_earnings_on_completion_by_id(p_request_id uuid)
RETURNS jsonb
LANGUAGE plpgsql
SECURITY DEFINER
AS $$
...
GRANT EXECUTE ON FUNCTION update_earnings_on_completion_by_id TO authenticated;
