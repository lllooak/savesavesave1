/*
  # Add default categories to platform_config

  1. Changes
    - Add default categories configuration to platform_config table
    - Set up predefined categories with icons and descriptions
    - Ensure categories are properly ordered and active
