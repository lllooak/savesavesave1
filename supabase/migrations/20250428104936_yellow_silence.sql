/*
  # Fix withdrawal status persistence

  1. Changes
    - Create a more robust function to handle withdrawal status changes
    - Ensure status changes are properly persisted in the database
    - Add notifications for status changes
    - Fix transaction recording for completed withdrawals
