/*
  # Update support_tickets table for contact form

  1. Changes
    - Add email column to support_tickets table
    - Update RLS policies to allow public form submissions
    - Create email notification function for new tickets
  
  2. Security
    - Add proper RLS policies for public submissions
    - Ensure admin-only access to manage tickets
*/
