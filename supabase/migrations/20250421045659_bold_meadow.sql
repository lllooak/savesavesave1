/*
  # Update platform fee to 30% and fix related functions

  1. Changes
    - Set default platform fee to 30%
    - Update process_request_payment function to use 30% fee
    - Add proper handling for creator earnings calculation
