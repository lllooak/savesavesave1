/*
  ...
  1. Changes
    - Add foreign key constraints for affiliate_commissions and affiliate_payouts tables
    - Ensure proper relationships with users table for affiliate_id columns
